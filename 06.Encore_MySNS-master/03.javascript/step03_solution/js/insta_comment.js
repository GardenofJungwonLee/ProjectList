...
function writeComment(id) {
    ...
    // [TO-DO 2] 배열을 문자열로 합치기
    // 등록시간, 별명, 댓글 내용을 array로 저장
    // 참고 : 배열을 합쳐서 문자열로 만들어주는 메소드 join()
    ...
    // [TO-DO 3] 문자열을 배열로 쪼개고 최신 데이터를 배열 맨 앞으로 추가
    // 위에 저장한 값을 추가해준다
...
function drawComment(id) {
    ...
    // [TO-DO 5] 댓글 읽어 들여와서 태그 안에 담아 보여주기
